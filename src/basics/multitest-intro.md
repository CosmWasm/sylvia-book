...
serialization from our tests. This won't pay off at first but as your contract will grow you will
...
with aquired code id and map address of received contract `addr`. It will on `instantiate` return
